...
public class Bombo {
    ...
    // El constructor creará una ArrayDeque<Bola> para inicializar la propiedad
    // “bolas”. A
    // continuación, le añadirá la cantidad de bolas indicada como parámetro. Cada
    // bola
    // tendrá un número aleatorio entre 1 y 100. No importa que se repitan los
    // números de
    // las bolas.
    public Bombo(int totalBolas) {
        ...
        for (int i = 0; i < totalBolas; i++) {
            bolas.add(new Bola(new Random().nextInt(1, 100)));
        }
    }
